...
const AppsiteDevelopementSection = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err);
            const msg = err.response?.data?.message || 'Failed to send message. Check server.';
            toast.error(msg);
        } finally {
            setLoading(false);
        }
        ...
        <>
            <style>
               ...
               .webdev-bg {
                        ...
                        background-image: url(${webBannerImage});
               ...
               .webdev-container {
                        position: relative; max-width: 1400px; margin: 0 auto; padding: 60px 20px;
                        display: flex; align-items: center; justify-content: space-between; gap: 50px;
                        min-height: 90vh; z-index: 1;
                        }
...
export default AppsiteDevelopementSection;